...
from features.features_generators import get_features_generator
from features.featurization import BatchMolGraph, MolGraph
from features.featurization import is_explicit_h, is_reaction
from features.featurization import make_mol
...
def set_cache_mol(cache_mol):
    global CACHE_MOL
    CACHE_MOL = cache_mol


class MoleculeDatapoint:
    def __init__(self, smiles, sequences, targets, row, data_weight, features, features_generator, atom_features, atom_descriptors, bond_features, overwrite_default_atom_features, overwrite_default_bond_features):
